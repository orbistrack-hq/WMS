...
export default async function WooCommerceIntegrationPage() {
  ...
  const [
    ...
    supabase
      ...
      .select(
        "id, source, site_id, is_active, last_synced_at, sync_inventory_outbound, sync_orders_outbound, site:sites(name)",
      )
  ...
  const orderQueueRows = mapOutboundOrderJobs(orderQueueRes.data, wooSiteIds)
