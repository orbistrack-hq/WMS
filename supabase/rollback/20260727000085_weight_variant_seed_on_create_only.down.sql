-- ============================================================================
-- WMS — Rollback 0085: restore always-apply stock on the weight-variant sync
--
-- OPERATIONAL WARNING: reversing this reinstates the one-way ratchet on every
-- weight variant (3.5g/7g/14g/28g) — the bulk of the catalog. A store count
-- below the WMS count reduces on_hand, and store sales are then subtracted twice.
--
-- Body copied verbatim from migration 0057. No data touched.
-- ============================================================================
