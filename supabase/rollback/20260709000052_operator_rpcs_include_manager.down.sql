-- ============================================================================
-- Rollback for migration 0052: restore the hardcoded admin/operator guard on the
-- six operator-level RPCs (managers rejected again). Bodies otherwise identical.
-- ============================================================================
